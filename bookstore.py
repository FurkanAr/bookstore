...
def new_book():
    '''
    Yeni kitap ve kitaba ait bilgileri ekleyeceğiz
    '''
    name = input("Yeni kitap ismini giriniz: ")
    author = input("Yazar ismini giriniz: ")
    publisher = input("Yayınevi ismini giriniz: ")
...
def display_book():
    ...
    if book != None:
       ...
       #print(f'Yayınevi: {book.publisher}')
        ...
        print("Aradığınız kitap bulunumadı.")
...
def edit_book():
    ...
    if book != None:
        ...
        new_amount = input("Yeni miktar bilgisini giriniz, aynı kalması için . giriniz: ")
        if new_amount != '.':
